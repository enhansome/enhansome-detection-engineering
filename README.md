...
* [Sigma Rules](https://github.com/SigmaHQ/sigma) ⭐ 11,018 | 🐛 201 | 🌐 Python | 📅 2026-09-07 - Sigma's repository of turnkey detection content. Content can be converted for use with most SIEMs.
* [Elastic Detection Rules](https://github.com/elastic/detection-rules/tree/main/rules) ⭐ 2,701 | 🐛 241 | 🌐 Python | 📅 2026-09-10 - Elastic's detection rules written natively for the Elastic SIEM. Can easily be converted for use by other SIEMs using Uncoder.
...
* [Splunk Security Content](https://github.com/splunk/security_content) ⭐ 1,687 | 🐛 13 | 🌐 Python | 📅 2026-09-10 - Splunk's open-source and frequently updated detection content that can be tweaked for use in other tools.
* [Elastic Endpoint Behavioral Rules](https://github.com/elastic/protections-artifacts/tree/main/behavior/rules) ⭐ 1,491 | 🐛 10 | 🌐 YARA | 📅 2026-09-03 - Elastic's endpoint behavioral (prevention) rules written in EQL, natively for the Elastic endpoint agent.
* [Elastic Yara Signatures](https://github.com/elastic/protections-artifacts/tree/main/yara/rules) ⭐ 1,491 | 🐛 10 | 🌐 YARA | 📅 2026-09-03 - Elastic's YARA signatures, which run on the Elastic endpoint agent.
* [Elastic Endpoint Ransomware Artifact](https://github.com/elastic/protections-artifacts/blob/main/ransomware/artifact.lua) ⭐ 1,491 | 🐛 10 | 🌐 YARA | 📅 2026-09-03 - Elastic's ranswomware artifact, which runs on the Elastic endpoint agent.
...
* [Panther Labs Detection Rules](https://github.com/panther-labs/panther-analysis/tree/main/rules) ⭐ 464 | 🐛 11 | 🌐 Python | 📅 2026-09-10 - Panther Lab's native detection rules.
* [Agent Threat Rules (ATR)](https://github.com/Agent-Threat-Rule/agent-threat-rules) ⭐ 389 | 🐛 81 | 🌐 TypeScript | 📅 2026-09-10 - An open MIT detection-rule standard for AI-agent and MCP attacks (prompt injection, tool poisoning, context exfiltration), like Sigma or YARA for the agent layer, with OWASP LLM/Agentic and MITRE ATLAS mappings on each rule.
...
* [RSigma | Timescale](https://github.com/timescale/rsigma) ⭐ 136 | 🐛 19 | 🌐 Rust | 📅 2026-09-10 - A complete Sigma detection engineering toolkit with parser, evaluation engine, rule conversion, streaming runtime, linter, CLI, MCP, and LSP.
...
* [Loghub](https://github.com/logpai/loghub) ⭐ 2,829 | 🐛 2 | 📅 2026-09-10 - Opensource and freely available security data sources for research and testing.
...
* [Rustinel | Karib0u](https://github.com/Karib0u/rustinel) ⭐ 479 | 🐛 58 | 🌐 Rust | 📅 2026-09-09 - Open-source endpoint detection engine for Windows and Linux that collects ETW/eBPF telemetry and evaluates Sigma, YARA, and IOC detections.
